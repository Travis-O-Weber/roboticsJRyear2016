...
task main()
{
	...
	while (true)
	{
	  ...
	  switch (nBtn)
	  {
	  	case kLeftButton:	  ++nLeftButton; PlaySound(soundDownwardTones);  			break;
			case kRightButton:	++nRightButton; PlaySound(soundUpwardTones); 			break;
			case kEnterButton:	++nEnterButton; PlaySound(soundBeepBeep); 			break;
			case kExitButton:	  ++nExitButton; PlaySound(soundLowBuzz); 			break;
	  ...
	  nxtDisplayTextLine(4, "  None    Exit  ");
	  nxtDisplayTextLine(5, " %5d    %5d", nNoButton, nExitButton);
